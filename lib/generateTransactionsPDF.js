...
// Dictionnaire des traductions pour le PDF
const translations = {
  fr: {
...
export function generateTransactionsPDF(transactions, options = {}) {
  const {
    ...
    balance = null,
    currency = "EUR",
    locale = "fr" // ⬅️ ajout du paramètre locale
  } = options;

  // Récupération des traductions pour la locale donnée (fallback sur fr)
